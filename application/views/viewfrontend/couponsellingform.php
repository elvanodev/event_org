    ...
    <div class="card main-content bg-transparent border-0">
        <div class="card-body earth-2073">
            ...
            <div class="form-group">
                ...
                <input type="tel" pattern="[0-9]{10,20}" class="form-control" id="memberPhone" name="memberPhone" placeholder="Nomor Telepon" required value="<?php echo $formdata['memberPhone']; ?>">
            </div>
        </div>
    </div>
