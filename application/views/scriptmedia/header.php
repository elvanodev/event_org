...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Website Penerimaan Peserta Didik Baru (PPDB) 2020/2021 SMA Regina Pacis Surakarta">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item  <?php echo (isset($active2)) ? $active2 : ''; ?> dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdown01">
                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Persyaratan">Persyaratan Pendaftaran</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Persyaratan2">Persyaratan Daftar Ulang</a>
                                    <!--<div class="dropdown-divider"></div>-->
                            ...
                            <li class="nav-item <?php echo (isset($active3)) ? $active3 : ''; ?>">
                                <a class="nav-link" href="<?php echo base_url(); ?>Prosedur">Prosedur Pendaftaran</a>
                            </li>
							<li class="nav-item <?php echo (isset($active4)) ? $active4 : ''; ?>">
                                <a class="nav-link" href="<?php echo base_url(); ?>Apresiasi">Apresiasi Pendidikan</a>
                            </li>
                            ...
                            if (!empty($this->session->userdata('idsiswa'))) {
                                ...
                                <li class="nav-item dropdown <?php echo (isset($active6)) ? $active6 : ''; ?>">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                                        ...
                                        if ($pendaftaran) {
                                            ?>
                                            <a class="dropdown-item" href="<?php echo base_url(); ?>Myaccount">Biodata Calon Siswa</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="<?php echo base_url(); ?>Ctrunggahsyarat">Unggah Syarat</a>
                                            <div class="dropdown-divider"></div>
                                            <?php
                                        }
                                        ?>
                                        <a class="dropdown-item" href="<?php echo base_url(); ?>Dokumen">Unduh Data Siswa</a>
                                        <div class="dropdown-divider"></div>

                                        <a class="dropdown-item" href="<?php echo base_url(); ?>Show/logout">Keluar</a>
                                    </div>
                                </li>
                            <?php } else { ?>
                                <li class="nav-item <?php echo (isset($active4)) ? $active4 : ''; ?>">
                                    <a class="nav-link" href="<?php echo base_url(); ?>Show/pendaftaran">Pendaftaran</a>
                                </li>
                                <li class="nav-item <?php echo (isset($active5)) ? $active5 : ''; ?>"  >
                                    <a class="nav-link" href="<?php echo base_url(); ?>Show/login">Masuk</a>
                                </li>
                            <?php } ?>
                        </ul>
                    </div>
