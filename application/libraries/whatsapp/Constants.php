...
class Constants {
    ...
    const WHATSAPP_VER = '2.18.287';                                                          // The WhatsApp version.
//    const WHATSAPP_USER_AGENT = 'WhatsApp/2.16.12 S40Version/14.26 Device/Nokia302';         // User agent used in request/registration code.
    const MANUFACTURER = 'Xiaomi';
    const BUILD_VERSION = 'JLS36C';
    const PLATFORM = 'Android';                                                              // The device name.
    const WHATSAPP_USER_AGENT = 'WhatsApp/2.18.287 Android/4.3 Device/Samsung-Galaxy_S3';
